...
<!--         <h1 class="logo me-auto"><img style="height: 50%" src="./assets/img/logo.png"></h1>
 -->
    ...
    <section id="hero" class="d-flex justify-content-center align-items-center">
      <div
        ...
        data-aos-delay="100"
      >
<!--       <a href="add.html">Add Associate</a>
 -->       
  <h1>Welcome, Admin</h1>
          ...
          <div class="row" style="justify-content: space-around;">
            <div class="col-lg-3 col-md-6 footer-contact">
             <!--  <h3>Admin</h3>
              <p>
                ...
                United States <br /><br />
                <strong>Phone:</strong> +91 89623 11939<br />
            ...
            <div class="col-lg-2 col-md-6 footer-links">
              ...
              <ul>
                ...
                <li>
                  <i class="bx bx-chevron-right"></i> <a href="about.jsp">About</a>
                </li>
                <li>
